...
mixin _$Behandlung {
 ...
 String get id; String get patientId; DateTime get startZeit; DateTime get endZeit; String? get rezeptId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Behandlung&&(identical(other.id, id) || other.id == id)&&(identical(other.patientId, patientId) || other.patientId == patientId)&&(identical(other.startZeit, startZeit) || other.startZeit == startZeit)&&(identical(other.endZeit, endZeit) || other.endZeit == endZeit)&&(identical(other.rezeptId, rezeptId) || other.rezeptId == rezeptId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,patientId,startZeit,endZeit,rezeptId);
...
@useResult
$Res call({
 String id, String patientId, DateTime startZeit, DateTime endZeit, String? rezeptId
});
...
/// Create a copy of Behandlung
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? patientId = null,Object? startZeit = null,Object? endZeit = null,Object? rezeptId = freezed,}) {
...
as DateTime,rezeptId: freezed == rezeptId ? _self.rezeptId : rezeptId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
class _Behandlung implements Behandlung {
  const _Behandlung({required this.id, required this.patientId, required this.startZeit, required this.endZeit, this.rezeptId});
...
@override final  String? rezeptId;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Behandlung&&(identical(other.id, id) || other.id == id)&&(identical(other.patientId, patientId) || other.patientId == patientId)&&(identical(other.startZeit, startZeit) || other.startZeit == startZeit)&&(identical(other.endZeit, endZeit) || other.endZeit == endZeit)&&(identical(other.rezeptId, rezeptId) || other.rezeptId == rezeptId));
}
...
/// Create a copy of Behandlung
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? patientId = null,Object? startZeit = null,Object? endZeit = null,Object? rezeptId = freezed,}) {
...
mixin _$BehandlungKalender {
 ...
 String get id; DateTime get startZeit; DateTime get endZeit; PatientSummary get patient; String? get rezeptId;
/// Create a copy of BehandlungKalender
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BehandlungKalenderCopyWith<BehandlungKalender> get copyWith => _$BehandlungKalenderCopyWithImpl<BehandlungKalender>(this as BehandlungKalender, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BehandlungKalender&&(identical(other.id, id) || other.id == id)&&(identical(other.startZeit, startZeit) || other.startZeit == startZeit)&&(identical(other.endZeit, endZeit) || other.endZeit == endZeit)&&(identical(other.patient, patient) || other.patient == patient)&&(identical(other.rezeptId, rezeptId) || other.rezeptId == rezeptId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,startZeit,endZeit,patient,rezeptId);
...
abstract mixin class $BehandlungKalenderCopyWith<$Res>  {
  factory $BehandlungKalenderCopyWith(BehandlungKalender value, $Res Function(BehandlungKalender) _then) = _$BehandlungKalenderCopyWithImpl;
@useResult
$Res call({
 String id, DateTime startZeit, DateTime endZeit, PatientSummary patient, String? rezeptId
});
...
/// Create a copy of BehandlungKalender
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? startZeit = null,Object? endZeit = null,Object? patient = null,Object? rezeptId = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,startZeit: null == startZeit ? _self.startZeit : startZeit // ignore: cast_nullable_to_non_nullable
as DateTime,endZeit: null == endZeit ? _self.endZeit : endZeit // ignore: cast_nullable_to_non_nullable
as DateTime,patient: null == patient ? _self.patient : patient // ignore: cast_nullable_to_non_nullable
as PatientSummary,rezeptId: freezed == rezeptId ? _self.rezeptId : rezeptId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of BehandlungKalender
...
class _BehandlungKalender implements BehandlungKalender {
  const _BehandlungKalender({required this.id, required this.startZeit, required this.endZeit, required this.patient, this.rezeptId});
  factory _BehandlungKalender.fromJson(Map<String, dynamic> json) => _$BehandlungKalenderFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$BehandlungKalenderCopyWith<_BehandlungKalender> get copyWith => __$BehandlungKalenderCopyWithImpl<_BehandlungKalender>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$BehandlungKalenderToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BehandlungKalender&&(identical(other.id, id) || other.id == id)&&(identical(other.startZeit, startZeit) || other.startZeit == startZeit)&&(identical(other.endZeit, endZeit) || other.endZeit == endZeit)&&(identical(other.patient, patient) || other.patient == patient)&&(identical(other.rezeptId, rezeptId) || other.rezeptId == rezeptId));
}
...
/// @nodoc
abstract mixin class _$BehandlungKalenderCopyWith<$Res> implements $BehandlungKalenderCopyWith<$Res> {
  factory _$BehandlungKalenderCopyWith(_BehandlungKalender value, $Res Function(_BehandlungKalender) _then) = __$BehandlungKalenderCopyWithImpl;
@override @useResult
$Res call({
 String id, DateTime startZeit, DateTime endZeit, PatientSummary patient, String? rezeptId
});
...
/// Create a copy of BehandlungKalender
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? startZeit = null,Object? endZeit = null,Object? patient = null,Object? rezeptId = freezed,}) {
...
mixin _$PatientSummary {
 ...
 String get id; String get name; DateTime? get birthday;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PatientSummary&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.birthday, birthday) || other.birthday == birthday));
}
...
/// Create a copy of PatientSummary
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? birthday = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PatientSummary&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.birthday, birthday) || other.birthday == birthday));
}
...
/// Create a copy of PatientSummary
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? birthday = freezed,}) {
