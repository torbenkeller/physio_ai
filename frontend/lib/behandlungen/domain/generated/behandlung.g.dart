...
_BehandlungKalender _$BehandlungKalenderFromJson(Map<String, dynamic> json) => _BehandlungKalender(
  id: json['id'] as String,
  startZeit: DateTime.parse(json['startZeit'] as String),
  endZeit: DateTime.parse(json['endZeit'] as String),
...
Map<String, dynamic> _$BehandlungKalenderToJson(_BehandlungKalender instance) => <String, dynamic>{
  'id': instance.id,
  'startZeit': instance.startZeit.toIso8601String(),
  'endZeit': instance.endZeit.toIso8601String(),
...
_PatientSummary _$PatientSummaryFromJson(Map<String, dynamic> json) => _PatientSummary(
  id: json['id'] as String,
  name: json['name'] as String,
  birthday: json['birthday'] == null ? null : DateTime.parse(json['birthday'] as String),
);

Map<String, dynamic> _$PatientSummaryToJson(_PatientSummary instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
