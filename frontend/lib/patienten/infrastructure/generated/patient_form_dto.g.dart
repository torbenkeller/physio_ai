...
_PatientFormDto _$PatientFormDtoFromJson(Map<String, dynamic> json) => _PatientFormDto(
...
Map<String, dynamic> _$PatientFormDtoToJson(_PatientFormDto instance) => <String, dynamic>{
