...
_RezeptFormDto _$RezeptFormDtoFromJson(Map<String, dynamic> json) => _RezeptFormDto(
...
Map<String, dynamic> _$RezeptFormDtoToJson(_RezeptFormDto instance) => <String, dynamic>{
  'patientId': instance.patientId,
  'ausgestelltAm': instance.ausgestelltAm.toIso8601String(),
  'positionen': instance.positionen,
};

_RezeptPositionDto _$RezeptPositionDtoFromJson(Map<String, dynamic> json) => _RezeptPositionDto(
  behandlungsartId: json['behandlungsartId'] as String,
  anzahl: (json['anzahl'] as num).toInt(),
);

Map<String, dynamic> _$RezeptPositionDtoToJson(_RezeptPositionDto instance) => <String, dynamic>{
