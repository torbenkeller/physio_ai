...
Map<String, dynamic> _$RezeptToJson(_Rezept instance) => <String, dynamic>{
  ...
  'positionen': instance.positionen.toJson((value) => value),
  'behandlungen': instance.behandlungen.toJson((value) => value),
};
...
Map<String, dynamic> _$RezeptPosToJson(_RezeptPos instance) => <String, dynamic>{
  'anzahl': instance.anzahl,
  'behandlungsart': instance.behandlungsart,
};

_Behandlungsart _$BehandlungsartFromJson(Map<String, dynamic> json) => _Behandlungsart(
  id: json['id'] as String,
  name: json['name'] as String,
  preis: (json['preis'] as num).toDouble(),
);

Map<String, dynamic> _$BehandlungsartToJson(_Behandlungsart instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'preis': instance.preis,
};

_RezeptPatient _$RezeptPatientFromJson(Map<String, dynamic> json) => _RezeptPatient(
  id: json['id'] as String,
  vorname: json['vorname'] as String,
  nachname: json['nachname'] as String,
);

Map<String, dynamic> _$RezeptPatientToJson(_RezeptPatient instance) => <String, dynamic>{
  'id': instance.id,
...
Map<String, dynamic> _$BehandlungToJson(_Behandlung instance) => <String, dynamic>{
  'id': instance.id,
