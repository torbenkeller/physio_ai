...
class ProfileController
    ...
    constructor(
        ...
        fun getProfile(): ProfileDto? {
            ...
            val profile = profileRepository.findById(ProfileId.Companion.fromUUID(id))
        ...
        fun updateProfile(
            ...
            return profileService
                .updateProfile(
                    id = ProfileId.Companion.fromUUID(id),
                    praxisName = profileFormDto.praxisName,
                    inhaberName = profileFormDto.inhaberName,
                    profilePictureUrl = profileFormDto.profilePictureUrl,
        ...
        ): String = kalenderService.calculateKalender(ProfileId.Companion.fromUUID(id), accessToken)
    }
